...
const APP_VERSION = "exploratory_bank_app_v3";
const APP_MODE = "debug";

const SESSION_CONFIG = {
  targetSessionMinutes: 2.5,
  targetSessionRangeSeconds: [120, 180],
  minimumUsefulSeconds: 90,
  ...
  interactionDesign: "exploratory_banking_app_with_open_navigation_and_natural_tap_scroll_type_drag_swipe_interactions",
